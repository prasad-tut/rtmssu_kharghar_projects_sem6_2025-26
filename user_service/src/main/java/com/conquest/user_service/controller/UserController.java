...
public class UserController {
	...
	@Autowired
	private com.conquest.user_service.client.TicketServiceClient ticketServiceClient;
	
	@GetMapping("/{userId}/tickets")
	public ResponseEntity<List<com.conquest.user_service.entity.TicketDTO>> getUserTickets(@PathVariable("userId") Integer userId) {
		return new ResponseEntity<>(ticketServiceClient.getTicketsRaisedByUser(userId), HttpStatus.OK);
	}
