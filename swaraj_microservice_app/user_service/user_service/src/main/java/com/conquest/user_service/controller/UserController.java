...
import com.conquest.user_service.client.TicketServiceClient;
...
public class UserController {
	...
	public ResponseEntity<List<TicketDTO>> getTicketRaisedById(@PathVariable("userId") Integer userId) {
    	return new ResponseEntity<>(ticketServiceClient.getTicketsByUserId(userId),HttpStatus.OK);
	}
}